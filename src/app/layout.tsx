...
export const metadata: Metadata = {
  title: "Nexus Studio — Premium Project Workspace",
  description:
    "A premium project management workspace for teams that care about craft. Boards, lists, cards, drag-and-drop, real-time progress.",
};
